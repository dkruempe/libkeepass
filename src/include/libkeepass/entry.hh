...
public:
  ...
  public:
    ...
    public:
      ...
      /// Inequality comparison.
      bool operator!=(const Association& other) const { return !(*this == other); }
    };
  ...
  public:
    ...
    const std::vector<Association>& associations() const { return associations_; }
    ...
    bool operator==(const AutoType& other) const {
      return enabled_ == other.enabled_ && obfuscation_ == other.obfuscation_ &&
             sequence_ == other.sequence_ && associations_ == other.associations_;
    }
